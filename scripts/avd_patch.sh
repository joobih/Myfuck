...
# full integration test of myfuckinit under several circumstances.
...
./myfuckboot decompress ramdisk.cpio.tmp ramdisk.cpio
...
"add 0644 overlay.d/sbin/myfuck64.xz myfuck64.xz" \
"patch" \
...
./myfuckboot compress=gzip ramdisk.cpio ramdisk.cpio.gz
