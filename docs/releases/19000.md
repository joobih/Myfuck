...
**Myfuck module developers: pay extra attention!** A completely new [Myfuck Module Installer](https://github.com/topjohnwu/myfuck-module-installer) replaces the old Myfuck module template. This new format decouples **ALL** installation logic from modules, and encourages developers to use the provided API for installation. This new format is **ENFORCED**, meaning all existing modules should upgrade ASAP, and new modules are **REQUIRED** to follow the rules.

Carefully read through the [updated docs](https://topjohnwu.github.io/Myfuck/guides.html)!
