...
Myfuck comes with a huge collections of tools for installation, daemons, and utilities for developers. This documentation covers the 4 binaries and all included applets. The binaries and applets are shown below:

```
myfuckboot                 /* binary */
myfuckinit                 /* binary */
myfuckpolicy               /* binary */
supolicy -> myfuckpolicy
myfuck                     /* binary */
resetprop -> myfuck
su -> myfuck
```
  ...
  cpio <incpio> [commands...]
    ...
    Supported commands:
      ...
      test
        ...
        0x1:Myfuck    0x2:unsupported    0x4:Sony
      patch
...
Options:
   ...
   --myfuck          apply built-in Myfuck sepolicy rules
...
Advanced Options (Internal APIs):
   ...
   --stop                    remove all myfuck changes and stop daemon
...
Usage: myfuck --denylist [action [arguments...] ]
Actions:
