...
import com.topjohnwu.myfuck.arch.ReselectionTarget
...
import com.topjohnwu.myfuck.utils.HideableBehavior
...
open class MainActivity : BaseUIActivity<MainViewModel, ActivityMainMd2Binding>() {
    ...
    private fun showUnsupportedMessage() {
        if (Info.env.isUnsupported) {
            MyfuckDialog(this)
                .applyTitle(R.string.unsupport_myfuck_title)
                .applyMessage(R.string.unsupport_myfuck_msg, Const.Version.MIN_VERSION)
                .applyButton(MyfuckDialog.ButtonType.POSITIVE) { titleRes = android.R.string.ok }
                .cancellable(false)
                .reveal()
        }
