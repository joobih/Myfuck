...
import com.topjohnwu.myfuck.databinding.ComparableRv
import com.topjohnwu.myfuck.databinding.ObservableDiffRvItem
import com.topjohnwu.myfuck.databinding.addOnPropertyChangedCallback
...
class ProcessRvItem(
    ...
    var isEnabled
        ...
        set(value) = set(value, process.isEnabled, { process.isEnabled = it }, BR.enabled) {
            ...
            Shell.cmd("myfuck --denylist $arg $pkg \'$name\'").submit()
        }
