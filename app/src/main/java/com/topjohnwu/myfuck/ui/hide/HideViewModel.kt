package com.topjohnwu.myfuck.ui.hide
...
import com.topjohnwu.myfuck.arch.Queryable
import com.topjohnwu.myfuck.arch.filterableListOf
...
class HideViewModel : BaseViewModel(), Queryable {
    ...
    override fun refresh() = viewModelScope.launch {
        ...
        val (apps, diff) = withContext(Dispatchers.Default) {
            ...
            val hideList = Shell.su("myfuckhide ls").exec().out.map { CmdlineHiddenItem(it) }
