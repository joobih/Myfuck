...
import com.topjohnwu.myfuck.core.UpdateCheckService
...
import com.topjohnwu.myfuck.core.utils.availableLocales
import com.topjohnwu.myfuck.core.utils.currentLocale
import com.topjohnwu.myfuck.databinding.DialogSettingsAppNameBinding
import com.topjohnwu.myfuck.databinding.DialogSettingsDownloadPathBinding
import com.topjohnwu.myfuck.databinding.DialogSettingsUpdateChannelBinding
...
object Myfuck : BaseSettingsItem.Section() {
    override val title = R.string.myfuck.asText()
}

object MyfuckHide : BaseSettingsItem.Toggle() {
    override val title = R.string.myfuckhide.asText()
    override val description = R.string.settings_myfuckhide_summary.asText()
    override var value = Config.myfuckHide
        set(value) = setV(value, field, { field = it }) {
            val cmd = if (it) "enable" else "disable"
            Shell.su("myfuckhide $cmd").submit { cb ->
                if (cb.isSuccess) Config.myfuckHide = it
                else field = !it
            }
        }
}
