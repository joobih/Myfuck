...
import com.topjohnwu.myfuck.core.Config.Value.DEBUG_CHANNEL
...
import com.topjohnwu.myfuck.core.data.GithubApiServices
import com.topjohnwu.myfuck.core.data.GithubPageServices
import com.topjohnwu.myfuck.core.data.RawServices
...
class NetworkService(
    ...
    suspend fun fetchUpdate() = safe {
        ...
        if (info.myfuck.versionCode < Info.env.versionCode &&
