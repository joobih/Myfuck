...
object Const {
    ...
    object Version {
        ...
        fun atLeast_21_0() = Info.env.myfuckVersionCode >= 21000 || isCanary()
        fun atLeast_21_2() = Info.env.myfuckVersionCode >= 21200 || isCanary()
        fun isCanary() = Info.env.myfuckVersionCode % 100 != 0
    }
    ...
    object Url {
        ...
        const val SOURCE_CODE_URL = "https://github.com/topjohnwu/Myfuck"

        val CHANGELOG_URL = if (BuildConfig.VERSION_CODE % 100 != 0) Info.remote.myfuck.note
        else "https://topjohnwu.github.io/Myfuck/releases/${BuildConfig.VERSION_CODE}.md"

        const val GITHUB_RAW_URL = "https://raw.githubusercontent.com/"
        const val GITHUB_API_URL = "https://api.github.com/"
        const val GITHUB_PAGE_URL = "https://topjohnwu.github.io/myfuck-files/"
        const val JS_DELIVR_URL = "https://cdn.jsdelivr.net/gh/"
        const val OFFICIAL_REPO = "https://myfuck-modules-repo.github.io/submission/modules.json"
    }
