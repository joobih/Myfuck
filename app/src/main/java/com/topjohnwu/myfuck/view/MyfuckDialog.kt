...
import com.topjohnwu.myfuck.databinding.DialogMyfuckBaseBinding
import com.topjohnwu.myfuck.utils.ObservableHost
...
class MyfuckDialog(
    ...
    private val binding: DialogMyfuckBaseBinding =
        DialogMyfuckBaseBinding.inflate(LayoutInflater.from(context))
    ...
    inner class Button : ObservableHost {
        ...
        fun clicked() {
            ...
            onClickAction(this@MyfuckDialog)
