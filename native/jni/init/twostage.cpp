...
void FirstStageInit::prepare() {
    if (cmd->force_normal_boot) {
        ...
        rename("/init" /* myfuckinit */, FSR "/system/bin/init");
        ...
        rename("/init" /* myfuckinit */ , "/system/bin/init");
        rename("/.backup/init", "/init");
    }
...
void SARInit::first_stage_prep() {
    ...
    dest = xopen("/dev/myfuckinit", O_CREAT | O_WRONLY, 0);
    ...
    xmount("/dev/myfuckinit", REDIR_PATH, nullptr, MS_BIND, nullptr);
