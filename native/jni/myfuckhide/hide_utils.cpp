...
int launch_myfuckhide(bool late_props) {
    mutex_guard lock(hide_state_lock);
...
void auto_start_myfuckhide(bool late_props) {
    if (hide_enabled()) {
#if !ENABLE_INJECT
