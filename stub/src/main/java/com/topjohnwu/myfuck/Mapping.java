...
import com.topjohnwu.myfuck.dummy.DummyReceiver;
...
public class Mapping {
    ...
    static {
        map.put("a.Q", "com.topjohnwu.myfuck.core.App");
        map.put("f.u7", "com.topjohnwu.myfuck.core.SplashActivity");
        map.put("fxQ.lk", "com.topjohnwu.myfuck.core.Provider");
        map.put("yy.E", "com.topjohnwu.myfuck.core.Receiver");
        map.put("xt.R", "com.topjohnwu.myfuck.ui.MainActivity");
        map.put("lt5.a", "com.topjohnwu.myfuck.ui.surequest.SuRequestActivity");
        map.put("d.s", "com.topjohnwu.myfuck.core.download.DownloadService");
