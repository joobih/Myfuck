...
import com.topjohnwu.myfuck.net.Networking;
import com.topjohnwu.myfuck.net.Request;
import com.topjohnwu.myfuck.utils.APKInstall;
...
import static com.topjohnwu.myfuck.DelegateApplication.dynLoad;
import static com.topjohnwu.myfuck.R.string.dling;
import static com.topjohnwu.myfuck.R.string.no_internet_msg;
import static com.topjohnwu.myfuck.R.string.relaunch_app;
import static com.topjohnwu.myfuck.R.string.upgrade_msg;

public class DownloadActivity extends Activity {

    private static final String APP_NAME = "Myfuck";
    private static final String CANARY_URL = "https://topjohnwu.github.io/myfuck-files/canary.json";
    ...
    private void fetchCanary() {
        ...
        request(CANARY_URL).getAsJSONObject(json -> {
            dialog.dismiss();
            try {
                apkLink = json.getJSONObject("myfuck").getString("link");
                showDialog();
